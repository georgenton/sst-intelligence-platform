...
The existing `module.work_permits` entitlement is authoritative; no new commercial key was added.
...
and detail routes; it does not create a separate pending-work dashboard.
